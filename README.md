...
<style>
  :root{
    --green-900:#0c4d1f; 
    --green-800:#0a3c16; 
    --green-light:#e6f4ec; /* verde claro */
    --yellow-300:#fff176; 
    --stone-200:#e7e7e7; 
    --white:#fff; 
  ...
  *{box-sizing:border-box;margin:0;padding:0}
  ...
  .hero{
    ...
    color:#fff;text-align:center;padding:56px 20px 40px
  }
  ...
  .btn-primary{
    background:var(--yellow-300);color:#181818;box-shadow:0 8px 22px rgba(198,167,93,.35)
  }
...
<section class="hero">
  ...
  <p>Transforme sua vida com clareza, segurança e prosperidade.  
     Libere os pesos do passado e construa relacionamentos, carreira e finanças com leveza.</p>
</section>
...
<section id="depoimentos">
  <div class="container">
    ...
    <div class="depos">
      <article class="depo"><p>“Participar da mentoria foi muito importante para mim. Tive resultados e despertares em várias áreas da minha vida — financeira, psicológica e principalmente emocional. Hoje me sinto leve, tranquila e confiante.”</p><small>Participante</small></article>
      <article class="depo"><p>“Aprendi que o dinheiro não é apenas números, mas carrega emoções, histórias e vínculos. Quando olhado com equilíbrio, nos ensina sobre dar e receber.”</p><small>Alini De Paris</small></article>
      <article class="depo"><p>“Cada dia que nasce é uma oportunidade de evoluir e ter consciência de como se quer viver. Mentoria Top!”</p><small>Fernando Lovison</small></article>
    </div>
  </div>
</section>
...
<section id="aplicacao">
  <div class="container">
    ...
    <div class="form-wrap">
      <p style="margin:0 0 18px;">Clique no botão abaixo e preencha o formulário oficial em nova aba:</p>
      <div class="cta-stack">
